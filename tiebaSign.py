...
class tieba:
    ...
    bdid = os.getenv('BDID', '')
    exec_time = os.getenv('AT', '02:00')
    if len(bduss) == 0 or len(bdid) == 0:
        print("bduss or bdid is null, bduss: " + bduss + ", bdid: " +bdid)
        sys.exit(1)

    url = 'http://tieba.baidu.com/home/main?un=' + bdid + '&fr=index'
